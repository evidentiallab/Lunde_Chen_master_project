...
\begin{figure}[!t]
    ...
    \caption{Running time versus number of nodes with PageRank using real and synthetic graph graph datasets for five iterations.}
...
\caption{Running time comparison between Hadoop and Spark using real and synthetic graph datasets. For each dataset, we make both implementations of PageRank iterate five times and record total time spent.}
...
\begin{figure*}[!t]
  ...
  \caption{PageRank run on Hadoop and Spark using synthetic graph datasets for five iterations. }
