...
import edu.umich.PowerTutor.log.DataDisplay;
import edu.umich.PowerTutor.log.PartiHealthCollector;
import edu.umich.PowerTutor.log.PartiHealthSaver;
import edu.umich.PowerTutor.log.PowerDataCollector;
import edu.umich.PowerTutor.log.PowerDataSaver;
...
public class UMLogger extends Activity  {
  ...
  public static PowerDataCollector powerDataCollector;
  public static PowerDataSaver powerDataSaver;
  public static PartiHealthCollector partiHealthCollector;
  public static PartiHealthSaver partiHealthSaver;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    dataDisplayButton= (Button)findViewById(R.id.datadisplaybutton);
    ...
    dataDisplayButton.setOnClickListener(dataDisplayButtonListener);
    ...
    if(counterService != null) {
      ...
      dataDisplayButton.setEnabled(false);
    }
  }
    ...
    new Button.OnClickListener() {
      public void onClick(View v) {
        ...
        if(counterService != null) {
            ...
            if(UMLogger.powerDataSaver!=null && PowerDataCollector.isLogging == true)
          	  UMLogger.powerDataSaver.stop();
            if(UMLogger.powerDataCollector!=null && PowerDataCollector.isLogging == true)
          	  UMLogger.powerDataCollector.stop();
            PowerDataCollector.isLogging = false;
            
            if(UMLogger.partiHealthSaver!=null && PartiHealthCollector.isLogging == true)
            	UMLogger.partiHealthSaver.stop();
            if(UMLogger.partiHealthCollector!=null && PartiHealthCollector.isLogging == true)
            	UMLogger.partiHealthCollector.stop();
          ...
          if(conn == null) {
            ...
            {
            powerDataCollector = new PowerDataCollector(UMLogger.this);
            powerDataSaver = new PowerDataSaver();
            }
            if(PartiHealthCollector.isLogging == false)
            {
            partiHealthCollector = new PartiHealthCollector(UMLogger.this);
            partiHealthSaver = new PartiHealthSaver();
            }
          }
        }
      }
  ...
  private class CounterServiceConnection implements ServiceConnection {
    public void onServiceConnected(ComponentName className, 
      ...
      appViewerButton.setEnabled(true);
      sysViewerButton.setEnabled(true);
      dataDisplayButton.setEnabled(true);
    }
  ...
  private Button.OnClickListener dataDisplayButtonListener =
		  new Button.OnClickListener() {
		    public void onClick(View v) {
		      Intent myIntent = new Intent(v.getContext(), DataDisplay.class);
