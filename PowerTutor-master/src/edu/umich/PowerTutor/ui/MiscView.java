...
public class MiscView extends Activity {
  ...
  public void refreshView() {
    ...
    // System.out.println("MiscView: RefreshView");
  ...
  public void onCreate(Bundle savedInstanceState) {
   ...
   // System.out.println("Activity: MiscView, onCreate");
  ...
  protected void onResume() {
    ...
    handler = new Handler();
    getApplicationContext().bindService(serviceIntent, conn, 0);
   // System.out.println("Activity: MiscView, onResume");
    refreshView();
  }
  ...
  protected void onPause() {
    super.onPause();
  //  System.out.println("Activity: MiscView, onPause");
    getApplicationContext().unbindService(conn);
    if(collector != null) {
    ...
    public void setupView() {
      ...
      if(current <= 0) {
        txt.setText(String.format("%1$.1f mA", -current * 1000));
         ...
         // System.out.println("current power: " + String.format("%1$.1f mA", -current * 1000));
      ...
      if(counterService != null) try {
        ...
        if(count > 0) {
          ...
          if(charge > 0 && volt > 0) {
           ...
           // System.out.println("Current Power: " + String.format("%1$.0f mW\n" +
          //          "time: %2$d:%3$02d:%4$02d", weightedAvgPower * 1000.0,
          //          time / 60 / 60, time / 60 % 60, time % 60));
          ...
          //  System.out.println("Current Power: " + String.format("%1$.0f mW", weightedAvgPower * 1000.0));
          }
        } else {
          txt.setText("No data");
          
        //  System.out.println("Current Power: " +"No data");
        }
      } catch(RemoteException e) {
        txt.setText("Error");
        //System.out.println("Current Power: " +"Error");
        ...
        if(power > 0) {
          ...
          if(charge > 0 && volt > 0) {
            ...
            txt.setText(String.format("%1$.0f mW\n" +
                        ...
                        time / 60 / 60, time / 60 % 60, time % 60));
            //System.out.println("Average Power: "+ String.format("%1$.0f mW\n" +
            //        "time: %2$d:%3$02d:%4$02d", power * 1000.0,
            //        time / 60 / 60, time / 60 % 60, time % 60));
          ...
          //  System.out.println("Average Power: "+ String.format("%1$.0f mW", power * 1000.0));
          }
        } else {
          txt.setText("No data");
          
         // System.out.println("Average Power: " + "No data");
        }
      } catch(RemoteException e) {
        txt.setText("Error");
        
      //  System.out.println("Average Power: " + "Error");
