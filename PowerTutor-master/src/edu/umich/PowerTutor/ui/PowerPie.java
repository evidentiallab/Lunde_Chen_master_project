...
public class PowerPie extends Activity {
  ...
  public void refreshView() {
      ...
      public void run() {
        try {
          ...
          if(sumTotal < 1e-7) {
            ...
            String label = String.format("%1$s %2$.1f %3$sJ",      //J在此....
        ...
        if(handler != null) {
         ...
         // System.out.println("hanlder.postDelayed..........");
        }
      }
    };
    
    if(handler != null) {
     // System.out.println("handler.post: first post");
   ...
   // System.out.println("PowerPie: refreshView");
  ...
  //  System.out.println("PowerPie: updateDisplayText");
  }
  ...
  class CounterServiceConnection implements ServiceConnection {
    public void onServiceConnected(ComponentName className, 
      ...
      //  System.out.println("PowerPie: CounterServiceConnection: onServiceConnected");
        refreshView();
      } catch(RemoteException e) {
        counterService = null;
      }
    ...
    public void onServiceDisconnected(ComponentName className) {
      ...
      //System.out.println("PowerPie: CounterServiceConnection: onServiceDisconnected");
  ...
  public void onCreate(Bundle savedInstanceState) {
   ...
   // System.out.println("Activity: PowerPie, onCreate");
  ...
  protected void onResume() {
    super.onResume();
    handler = new Handler();
    //System.out.println("Activity: PowerPie, onResume");
    getApplicationContext().bindService(serviceIntent, conn, 0);
  ...
  protected void onPause() {
    ...
    //System.out.println("Activity: PowerPie, onPause");
