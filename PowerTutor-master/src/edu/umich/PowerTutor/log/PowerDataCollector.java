...
public class PowerDataCollector {
	...
	public static ArrayBlockingQueue<String> myArrBlockQueue;
	...
	public PowerDataCollector(Context context)
	{
	    ...
	    myArrBlockQueue = new  ArrayBlockingQueue<String>(PowerConstants.ARR_BLOCK_QUEUE_SIZE);
					...
					// TODO Auto-generated method stub
					 while(isLogging)
					 {
						 try {
						    ...
						    myArrBlockQueue.add(getLogData(KEY_CURRENT_POWER));
						    System.out.println(myArrBlockQueue.toString());
							logStr = "";
