...
public class PartiHealthSaver {
	...
	public void read()
	{
		while(PartiHealthCollector.isLogging == true)
		{
		try {
			synchronized (saveThread) {
				String takeStr = PartiHealthCollector.myArrBlockQueue2.take();
	...
	public void write(List<String> buf, int type)
	{
		...
		String fileStr = PowerConstants.ROOT_DIR  + dateString+ "_parti_health_log.txt";
