 ...
 *  to spidermonkey (or looked at by the user) and to implement the
...
public class PowerEstimator implements Runnable {
  ...
  private void openLog(boolean init) {
    ...
    try {
      ...
      ////////////////////////////////////////////
     // System.out.println(deflateStream);
            ...
            if(uid < SystemInfo.AID_APP) {
              ...
              if(!firstLogIteration && logStream != null &&
                ...
                try {
                  ...
                  // System.out.println("synchronized update the uid set:");
                  // System.out.println(uid + " : " + newAppId);
                } catch(IOException e) {
            ...
            if(data != null) {
              ...
              for(int j = 0; j < uidData.size(); j++) {
                ...
                //  System.out.print("name: " + name + " ");
                  //System.out.print("AppName: " + "Unknown");
                //  System.out.println("powerData.getCachedPower(): "+ powerData.getCachedPower());
  ...
  public void writeToLog(String m) {
    synchronized(fileWriteLock) {
      if(logStream != null) try {
    	 // System.out.println("writeToLog: " + m);
        logStream.write(m);
      } catch(IOException e) {
        Log.w(TAG, "Failed to write message to power log");
      //  System.out.println("writeToLog: " + "fail!!!!");
      }
    }
  }
